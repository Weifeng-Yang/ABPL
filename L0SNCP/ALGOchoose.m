...
if(flag==0)
[vars,loss,tr,btss]=PALM(var,ngmar,aa,maxiteropt,num,N,stopindex,r);
varss{1}=vars;
lossdata{1}=loss;
trdata{1}=tr;
btz{1}=btss;
...
elseif(flag==1) 
[vars,loss,tr,btss,atz]=IPALM(var,ngmar,aa,maxiteropt,num,N,stopindex);
varss{1}=vars;
lossdata{1}=loss;
trdata{1}=tr;
btz{1}=btss;
...
elseif(flag==2)
[vars,loss,tr,btss]=BPL(var,ngmar,aa,maxiteropt,num,N,stopindex,r);
varss{1}=vars;
lossdata{1}=loss;
trdata{1}=tr;
btz{1}=btss;
...
elseif(flag==3) 
[vars,loss,tr,btss,ats]=IBPG(var,ngmar,aa,maxiteropt,num,N,stopindex,r);
varss{1}=vars;
lossdata{1}=loss;
trdata{1}=tr;
btz{1}=btss;
...
elseif(flag==4) 
[vars,loss,tr,btss]=TITAN(var,ngmar,aa,maxiteropt,num,N,stopindex,r);
varss{1}=vars;
lossdata{1}=loss;
trdata{1}=tr;
btz{1}=btss;
